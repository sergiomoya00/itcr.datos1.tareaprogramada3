...
public class Geocoding {
    ...
    public static String getName(String namePlace) throws ApiException, InterruptedException, IOException {
    ...
    public static String rutaMapa(String AddressOne, String AddressTwo) throws ApiException, InterruptedException, IOException, URISyntaxException {

        String origin = getName(AddressOne);
        String destiny = getName(AddressTwo);

        String urlstring = "https://www.google.com/maps/dir/";
        urlstring = urlstring + origin + "/";
        urlstring = urlstring + destiny + "/";
